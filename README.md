...
As it is and we thought that we may overshoot the goal with needless complexity for the task with a self-contained physical instance, even though it potentially it could provide much more than an app.

We created multiple paper prototypes of the app to get a feel for it. See the prototypes below:
...
This way each team member created their own first app paper prototype uninfluenced and with their own ideas.
...
The result was a discussion with each team member already having their own point of view.
